...
public class TaskController {
    ...
    @GetMapping("/edit/{id}")
    public ModelAndView edit(@PathVariable(value = "id") Long id, ModelAndView modelAndView) {
    ...
    @PostMapping("/edit/{id}")
    public String edit(@PathVariable(value = "id") Long id, TaskBindingModel taskBindingModel) {
    ...
    public ModelAndView delete(@PathVariable(value = "id") Long id, ModelAndView modelAndView) {
        Task task = this.taskRepository.findById(id).get();
        modelAndView.setViewName("base-layout");
