...
public class TaskController {
    ...
    public String edit(TaskBindingModel taskBindingModel,
                       @PathVariable(value = "id") Integer id) {
        Task taskToEdiit = this.taskRepository.findById(id).get();
        taskToEdiit.setTitle(taskBindingModel.getTitle());
        taskToEdiit.setStatus(taskBindingModel.getStatus());
        this.taskRepository.saveAndFlush(taskToEdiit);
        return "redirect:/";
    }
