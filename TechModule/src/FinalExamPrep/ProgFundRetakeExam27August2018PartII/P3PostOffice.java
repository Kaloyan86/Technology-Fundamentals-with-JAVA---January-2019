package FinalExamPrep.ProgFundRetakeExam27August2018PartII;
...
public class P3PostOffice {
    public static void main(String[] args) {
        ...
        matches.forEach((ascii, length) -> {
            Arrays.stream(thirdEncryptedMessage.split("\\s+")).forEach(word -> {
                if (word.length() == length + 1 && String.valueOf(word.charAt(0)).equals(ascii)) {
